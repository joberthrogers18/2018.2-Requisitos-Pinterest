...
|**Restrição**|
| O [usuário](lexicos.md#l14) [seguir outro usuário](#c13. |
|**Exceção** |
...
|**Episódios** |
| [Fazer login](#c8 <br> [Usuário](lexicos.md#l14) clica em sua página de [perfil](lexicos.md#l17) no canto superior direito da tela <br> [Usuário](lexicos.md#l14) seleciona a aba [Pins](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) seleciona o [pin](lexicos.md#l1) que deseja editar <br> [Usuário](lexicos.md#l14) clica no ícone de editar simbolizado por um lápis no canto superior esquerdo da tela. <br> **ou** <br> [Fazer login](#c8 <br> [Usuário](lexicos.md#l14) clica em sua página de [perfil](lexicos.md#l17) no canto superior direito da tela <br> [Usuário](lexicos.md#l14) seleciona a aba [Pins](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) passa o mouse sobre o [pin](lexicos.md#l1) que deseja editar <br> [Usuário](lexicos.md#l14) clica no ícone de editar simbolizado por um lápis na parte superior do [pin](lexicos.md#l1). <br> **ou** <br> [Fazer login](#c8 <br> [Usuário](lexicos.md#l14) clica em sua página de [perfil](lexicos.md#l17) no canto superior direito da tela <br> [Usuário](lexicos.md#l14) seleciona a [aba](lexicos.md#l7) Pastas <br> [Usuário](lexicos.md#l14) clica na pasta que está o [pin](lexicos.md#l1) que deseja editar <br> [Usuário](lexicos.md#l14) passa o mouse sobre o [pin](lexicos.md#l1) que deseja editar <br> [Usuário](lexicos.md#l14) clica no ícone de editar simbolizado por um lápis na parte superior do [pin](lexicos.md#l1). <br> **ou** <br> [Fazer login](#c8 <br> [Usuário](lexicos.md#l14) clica em sua página de [perfil](lexicos.md#l17) no canto superior direito da tela <br> [Usuário](lexicos.md#l14) seleciona a [aba](lexicos.md#l7) "pastas" <br> [Usuário](lexicos.md#l14) clica na [pasta](lexicos.md#l3) que está o [pin](lexicos.md#l1) que deseja editar) <br> [Usuário](lexicos.md#l14) seleciona o [pin](lexicos.md#l1) que deseja [editar](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) clica no ícone de editar simbolizado por um lápis no canto superior esquerdo da tela.|
...
|**Contexto** |
| Local: Página de detalhes de um [Pin](lexicos.md#l1) <br>  Pré-Condição: o [usuário](lexicos.md#l14) deverá estar [logado](lexicos.md#l6) em sua conta do [Pinterest](lexicos.md#l9) <br>  Pós-Condição: O [Pin](lexicos.md#l1) é salvo em uma [pasta](lexicos.md#l3). |
|**Atores** |
| [Usuário](lexicos.md#l14) |
|**Recursos** |
...
| - |
|**Exceção** |
| Internet cair <br> App dar [crash](lexicos.md#l20) <br> [Pin](lexicos.md#l1) ser excluído ao ser salvo <br> Não existir [pastas](lexicos.md#l3) para salvá-lo |
|**Episódios** |
| [Usuário](lexicos.md#l14) abre o aplicativo <br> [Usuário](lexicos.md#l14) entra na [página](lexicos.md#l7) inicial para visualizar e [navegar](lexicos.md#l36) pelo [feed](lexicos.md#l15) de [Pins](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) seleciona um [Pin](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) clica no botão salvar <br> [Usuário](lexicos.md#l14) escolhe a [pasta](lexicos.md#l3) para salvá-lo e se não houverem [pastas](lexicos.md#l3) criadas, cria uma [pasta](lexicos.md#l3) para poder salvar o [Pin](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) salvar o [Pin](lexicos.md#l1) na [pasta](lexicos.md#l3) |
...
| [Salvar](lexicos.md#l2) um [Pin](lexicos.md#l1) em uma [pasta](lexicos.md#l3) criada pelo [usuário](lexicos.md#l14) do [Pinterest](lexicos.md#l9) |
|**Contexto** |
| Local: Página de detalhes de um [Pin](lexicos.md#l1) <br>  Pré-Condição: o [usuário](lexicos.md#l14) deverá estar [logado](lexicos.md#l6) em sua conta do [Pinterest](lexicos.md#l9) <br> [Usuário](lexicos.md#l14) estar com o aplicativo Pinterest aberto <br>  Pós-Condição: O [Pin](lexicos.md#l1) é salvo em uma [pasta](lexicos.md#l3). |
|**Atores** |
| [Usuário](lexicos.md#l14) |
|**Recursos** |
| Internet, aplicativo, [conta de usuário](lexicos.md#l32), [pin](lexicos.md#l1) |
...
| Internet cair <br> App dar [crash](lexicos.md#l20) <br> [Pin](lexicos.md#l1) ser excluído ao ser salvo <br> Não existir [pastas](lexicos.md#l3) para salvá-lo |
|**Episódios** |
| [Usuário](lexicos.md#l14) entra na [página](lexicos.md#l7) inicial para visualizar e [navegar](lexicos.md#l36) pelo [feed](lexicos.md#l15) de [Pins](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) seleciona um [Pin](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) clica no botão salvar <br> [Usuário](lexicos.md#l14) escolhe a [pasta](lexicos.md#l3) para salvá-lo e se não houverem [pastas](lexicos.md#l3) criadas, cria uma [pasta](lexicos.md#l3) para poder salvar o [Pin](lexicos.md#l1) <br> [Usuário](lexicos.md#l14) salvar o [Pin](lexicos.md#l1) na [pasta](lexicos.md#l3) |
