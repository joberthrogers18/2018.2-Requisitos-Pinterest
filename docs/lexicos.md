...
|  Versão |  Modificação |
|  :------: | :------: |
|  1.0  | A Primeira versão dos léxicos foram feitas por todo o grupo, para as primeiras entregas referentes ao módulo, antes das entrega final. A Cada versão, obteve-se adição de termos para composição dos léxicos, de forma que essa versão reflita bem como foram montados |
|  2.0  | A Segunda versão busca atender a propostas de composição dos léxicos conforme orientação, com adição das classificações e reformulação de alguns léxicos quanto a noção e impacto, feita por todo o grupo|
...
|**Noção**|
|--|
|  Uma imagem ou conteúdo exibido dentro do [Pinterest](#l9). <br> É a principal moeda de interação do [usuário](#l14). <br> A interação ocorre a partir deste construto. |
|**Classificação**|
|Objeto|
|**Impacto** |
| O Pin pode ser [compartilhado](#compartihar), comentado, [pinado](#l2) em uma [pasta](#l3) ou [subpasta](#l4) e [baixado](#l24). <br> O [usuário](#l14) consome pins do [Pinterest](#l9) para buscar inspiração. <br> O [usuário](#l14) pode denunciar um [pin](#l1) caso ele seja contra as Diretrizes da Comunidade do [Pinterest](#l9). <br> O [usuário](#l14) pode marcar o Pin como já [experimentado](#experimentado). <br> Dentro de um Pin é possível pesquisar por itens visualmente semelhantes. <br> Dentro de um Pin é possível copiar o link da imagem que redireciona para o [Pinterest](#l9). <br> Os pins estão presentes dentro do [feed](#l15). <br> Os pins possuem [interesses](#l10) relacionados a eles. <br> Os pins são salvos em [pastas](#l3).|
|**Sinônimos**|
|Pins, Imagem, Imagens, Foto, Fotos, Post, Posts, Postagem|
...
|**Noção**|
|--|
|	É uma coleção de [pins](#l1), contendo título para poder se diferenciar de outras coleções.  |
|**Classificação**|
|Objeto|
|**Impacto** |
| O [usuário](#l14) [pina](#l2) [pins](#l1) em um pasta. <br> O [usuário](#l14) pode criar subpastas para [organizar](#l33) os [pins](#l1) da pasta. <br> O [usuário](#l14) pode convidar outros [usuários](#l14) para [colaborar](#l26) com outros [pins](#l1) dentro do [pasta](#l3). <br> Uma pasta pode ser [seguida](#l8) por outro [usuário](#l14) para ser acompanhada. <br> Uma pasta pode ser [recomendada](#l27) para [usuários](#l14) por determinados [interesses](#l10). <br> É utilizado pelos [usuários](#l14) para [organizar](#l33) os seus [pins](#l1) [pinados](#l2). <br> Pode possuír sub-conjuntos denominados [subpastas](#l4). |
|**Sinônimos**|
| Pastas, Board, Boards |
...
|Estado|
|**Impacto** |
| Permite que o [usuário](#l14) preserve um histórico de pesquisas e [mensagens](mensagens). <br> Permite que o [usuário](#l14) crie [pastas](#pastas) e [subpastas](#l4) e as [compartilhe](#l12). <br> Permite que o usuário edite informações do seu [perfil](#l17).|
|**Sinônimos**|
| Autenticado |
...
|**Noção**|
|--|
| Ação de remover o [pin](#l1) do [feed](#l15) do [usuário](#l14) do Pinterest. <br> Ato de indicar que o [interesse](#l10) que gerou aquele [pin](#l1) pode não mais ser relevante.|
|**Classificação**|
|Verbo|
|**Impacto** |
| Conforme o [usuário](#l14) oculte [pins](#l1) de determinado interesse, a relevância desse interesse diminui. <br> O [Pinterest](#l9) impede que [Pins](#l1) daquele mesmo [interesse](#l10) seja mostrado ao [usuário](#l14) no [feed](#l15). <br> O [Pinterest](#l9) pode fazer com que aquele [pin](#l1) seja removido ao ser ocultado de muitos [feeds](#l15)|
...
|**Noção**|
|--|
| Utilizador do [Pinterest](#l9). Aquele possui uma [conta de usuário](#l32)|
|**Classificação**|
|Objeto|
|**Impacto** |
| [Pinterest](#l9) fornece todos os seus serviços e ferramentas ao usuário. <br> O usuário pode [compartilhar](#l12), [pinar](#l2), [comentar](#l23) nos [pins](#l1). <br> O [usuário](#l14) pode [seguir](#l8) outros usuários, definir seus [interesses](#l10) e [explorar](#l11) no [Pinterest](#l9).  |
...
|**Noção**|
|--|
| Conjuto de dados cadastrados e [interesses](#l10) definidos pelo [usuário](#l14) para identifica-lo. Criado no término do [cadastro](#cadastro).|
|**Classificação**|
|Objeto|
|**Impacto** |
| Com o perfil de [usuário](#l14) é possivel que outros [usuários](#l14) possam reconhecê-lo, [seguir](#l8) uns ao outros, mandar [mensagens](#l18) ou [compartilhar](#l12) [pins](#l1) e [pastas](#l3). |
...
|Objeto|
|**Impacto** |
| O [usuário](#l14) pode se comunicar com outros usuários podendo começar uma conversa de texto ou [compartilhar](#l12) um [pin](#l1). <br> O [usuário](#l14) pode enviar um [pin](#l1) para pessoas que não possuem [pinterest](#l9). <br> Quando o [usuário](#l14) destinatário vizualiza a mensagem, aparece uma indicação de leitura para quem enviou a mensagem. |
...
|Estado|
|**Impacto** |
|O aplicativo fecha e o [usuário](#l14) deixa de concluir qualquer ação no app. <br> indica que o aplicativo não funcionou corretamente. <br> Pode indicar também que a aplicação parou de funcionar em um estado |
...
|**Impacto**|
| O [usuário](#l14) pode baixar [imagem](#l1) para usar como papel de parede em seu dispositivo. <br>  O [usuário](#l14) pode baixar a [imagem](#l1) e poder usar em outros lugares. |
...
|**Noção**|
|--|
| Ato de guardar na área de transferência do dispositivo o link do caminho do [pin](#l1) no [Pinterest](#l9).  |
|**Classificação**|
|Verbo|
|**Impacto**|
| O [usuaŕio](#l14) pode copiar a imagem para enviar para outros [usuários](#l14) em outras rede sociais. <br> O [usuário](#l14) pode copiar a [imagem](#l1) e poder usar em outros lugares.  |
...
|**Noção**|
|--|
| Poder apagar um [pin](#l1) [salvo](#l2) de uma [pasta](#l3) ou a própria [pasta](#l3). <br> Fazer um [pin](#l1), [pasta](#l3) ou [subpasta](#l4) deixar de existir.  |
|**Classificação**|
|Verbo|
|**Impacto**|
| O [usuário](#l14) consegue deletar os [pins](#l1) [salvos](#l2) que não são mais de seu [interesse](#l10) ou não queira mais em seus arquivos, assim também se não quiser mais alguma [pasta](#l3), pode-se apaga-la.
...
|**Sinônimos**|
|Mudar de lugar, trocar, transferir|
...
|Verbo|
|**Impacto**|
| O [usuário](#l14) pode mudar a ordem da organização das suas [pastas](#l3) e [subpastas](#l4). <br> O [usuário](#l14) pode [transferir](#l29) [pins](#l1) entre [pastas](#l3) e [subpastas](#l4). <br>  O [usuário](#l14) pode [excluir](#l28) [pins](#l1) |
...
|Objeto|
|**Impacto** |
| Para que o [usuário](#l14) interaja com o várias funções do sistema é necessário possuir uma conta de usuário. <br> O [usuário](#l14) deve possuir uma conta para visualizar informações do [pinterest](#l9)|
|**Sinônimos**|
| Conta |
